    ...
    <div className="contact-wrapper">
      ...
      <footer className="footer">
        ...
        <div className="footer-credits">
          <h4>Credits</h4>
          <p>
            Shreeraj Babar(Technical Secretary)  , Mayuresh Kalal(Technical Co-Secretary)  , Tushar Pawar(Technical Advisory)  , Janmejay Singh Rathore (Technical Lead)  , Vedant Darange (Technical Co-Lead)  , Anam Patave  , Yash Badane  , Nikita Gadalikar  , Sammrudhi Patabhaje , Trupti Aswar , Prajwal Methe  
          </p>
        </div>
      </footer>
    </div>
